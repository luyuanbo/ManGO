package com.lv.mama.lvv.cart.adapter;
...
public class ShopcartAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, final boolean isLastChild, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            cholder.iv_adapter_list_pic = convertView.findViewById(R.id.iv_adapter_list_pic);
        ...
        if (goodsInfo != null) {
            ...
            cholder.iv_adapter_list_pic.setImageURI(goodsInfo.getGoodsImg());
    ...
    private class ChildViewHolder {
        CheckBox cb_check;
        SimpleDraweeView iv_adapter_list_pic;
